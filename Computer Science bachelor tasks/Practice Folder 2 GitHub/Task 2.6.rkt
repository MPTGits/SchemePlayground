...
(define (automorphic? n) (define (auto-checker n pown counter) (cond ((= (remainder pown counter) n) true)
                                                                     ((= pown (remainder pown counter)) false )
                                                                     (else (auto-checker n pown (* counter 10)))))
  (auto-checker n (* n n) 10))
